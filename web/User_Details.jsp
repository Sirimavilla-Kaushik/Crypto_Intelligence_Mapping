<%-- 
    ...
    Created on : 14-Oct-2025, 10:37:00
    Author     : user
--%>
...
<html class="no-js" lang="">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                <div class="nav-item dropdown">
                  ...
                  <a href="User_Details.jsp" class="nav-item nav-link active">User Details</a>
   ...
   <h2 class="header-title" style="text-align:center; margin: 20px;">User Details</h2>
        ...
        <table style="width: 100%">
            ...
            <%
                ...
                ResultSet transRs = db.Select("SELECT * FROM user_registration");
                boolean hasData = false;
                while (transRs.next()) {
                    hasData = true;
                    int tId = transRs.getInt("U_Id");
                    String sender = transRs.getString("User_Name");
                    String receiver = transRs.getString("Email");
                    String Tx_Hash = transRs.getString("Mobile_Number");
                    String date = transRs.getString("City");
                    String status = transRs.getString("Status");
                    String flagged = transRs.getString("Ip_Address");
            %>
            <tr>
                <td><%=tId%></td>
                <td>
                    <div class="card1-image">
                        <img src="User_Img.jsp?name=<%= transRs.getInt("U_Id") %>"
