<%-- 
    Document   : Threat_Analysis_Log
    Created on : 10-Oct-2025, 14:34:57
    Author     : user
--%>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                <a href="Threat_Analysis_Log.jsp" class="nav-item nav-link active">Threat Analysis</a>
...
<h2 class="header-title">Threat Analysis Login</h2>
            
            <div class="formbold-main-wrapper">

  <div class="formbold-form-wrapper">
    
    <form action="Threat_Analysis_Log" method="post" >      
