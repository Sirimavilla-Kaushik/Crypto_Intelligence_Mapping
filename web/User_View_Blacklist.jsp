<%-- 
    Document   : User_View_Blacklist
    Created on : 20-Jan-2026, 12:47:31
    Author     : user
--%>
...
@keyframes fadeIn {
       ...
       <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                <a href="User_View_Blacklist.jsp" class="nav-item nav-link active">View BlackList</a>
    ...
    <h2 class="header-title" style="text-align:center; margin: 20px;">View BlackList Transactions</h2>
        ...
        <table style="width: 100%">
            ...
            <%
                ...
                ResultSet transRs = db.Select("SELECT * FROM transactions where Flagged=1 ORDER BY Date_Time ASC");
