<%-- 
    Document   : User_Login
    Created on : 21 Aug, 2025, 12:36:41 PM
--%>
...
<div id="spinner"
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                <a href="User_Login.jsp" class="nav-item nav-link active">User Login</a>
    ...
    <!-- Header End -->
        ...
        <div class="container1">
            <div class="formbold-main-wrapper"style="margin: 0px;">
        ...
        <div class="container2">
            ...
            <div class="formbold-main-wrapper"style="margin: 0px;">
                    ...
                    <form action="User_Login" method="post" >      
                        ...
                        <input type="hidden" name="Email" value="<%=Email%>" placeholder="Enter your OTP" class="formbold-form-input" required />
