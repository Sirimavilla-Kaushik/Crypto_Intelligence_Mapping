<%-- 
    Document   : Transaction_List1
    Created on : 10-Oct-2025, 14:48:50
    Author     : user
--%>
...
<html class="no-js" lang="">
    ...
    <div class="spinner-grow text-primary" role="status"></div>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-4 py-lg-0">
                ...
                <a href="Transaction_List1.jsp" class="nav-item nav-link active">Transaction List</a>
    ...
    <h2 class="header-title" style="text-align:center; margin: 20px;">Overall Transactions</h2>
        ...
        <table>
            ...
            <%
                ...
                ResultSet transRs = db.Select("SELECT * FROM transactions ORDER BY Date_Time ASC");
                ...
                while (transRs.next()) {
                    ...
                    String risk = transRs.getString("Risk_Score");
